...
-   Estructura del curso
    ...
    -   4 sesiones de 5 horas cada una. Días Sábados 14, 21, 28 de octubre, y 11 de noviembre.

    -   9H00 a 15H00 (1 hora de receso de 12H00 a 13H00)
...
-   Amplio abanico de paquetes/librerías (19933 al 24.09.2023).
...
## Operadores Booleanos de comparación en R
...
-   Existen también los operadores Booleanos lógicos (comparación del resultado entre dos comparaciones), pero no entraremos en detalle de estos.
...
-   Otros recursos de aprendizaje y ayuda de R:
    ...
    -   [STHDA](http://www.sthda.com/){target="_blank"}
...
+----------------------------------------------------------------------------+--------------+
| Los creadores de R, fueron Gentleman e Ihaka de la universidad de Auckland | V / F        |
+----------------------------------------------------------------------------+--------------+
| `5 * 5 * 5` es equivalente a `5 ^ 3`                                       | V / F        |
+----------------------------------------------------------------------------+--------------+
| Una lista es un arreglo que admite datos de una sola clase únicamente      | V / F        |
+----------------------------------------------------------------------------+--------------+
| Queremos comparar si `x` es igual a `5`, es esto correcto:`x = 5`          | V / F        |
+----------------------------------------------------------------------------+--------------+
| La función `data.frame` nos permite crear manualmente tablas de datos      | V / F        |
+----------------------------------------------------------------------------+--------------+

## Autoevaluación \# 1 {visibility="uncounted"}

+------------------------------------------------------------------------------+-------------+
| Al crear un objeto de esta forma: `1_cuenta = 12` R lo crea sin error alguno | V / F       |
+------------------------------------------------------------------------------+-------------+
| Si dejo un espacio en el nombre de un objeto, R me devuelve un error         | V / F       |
+------------------------------------------------------------------------------+-------------+
| El comando `install.libraries` me permite instalar librerías                 | V / F       |
+------------------------------------------------------------------------------+-------------+
| En la expresión genérica `mean(x, . . .)` los puntos representan argumentos  | V / F       |
+------------------------------------------------------------------------------+-------------+
| Es la siguiente expresión correcta: `z -> c(1, 2, 3)`                        | V / F       |
+------------------------------------------------------------------------------+-------------+
...
+-----------------------------------------------------------------------------+--------------+
| `x` es un argumento de la función                                           | V / F        |
+-----------------------------------------------------------------------------+--------------+
| `na.rm` es otro argumento de la función                                     | V / F        |
+-----------------------------------------------------------------------------+--------------+
| `na.rm` le dice a la función `sd` que **NO** remueva observaciones perdidas | V / F        |
+-----------------------------------------------------------------------------+--------------+
| `sd` es la función de la librería `base` que calcula la desviación estándar | V / F        |
+-----------------------------------------------------------------------------+--------------+
...
-   Sobre todo en casos como:
    ...
    -   Automatizar nuestro código para tareas repetitivas (analizar varias tabla de datos con una estructura predeterminada y poco variable).
:::
...
+------------------------------------------------------------------------------------+-------------+
| El coeficiente de variación es adimensional                                        | V / F       |
+------------------------------------------------------------------------------------+-------------+
| La media poblacional se aproxima a la media muestral con una corrección            | V / F       |
+------------------------------------------------------------------------------------+-------------+
| La desv. est. muestral es un estimador de la poblacional después de una corrección | V / F       |
+------------------------------------------------------------------------------------+-------------+
| La moda es igual al valor medio de una distribución                                | V / F       |
+------------------------------------------------------------------------------------+-------------+
| El primer cuartil corresponde al 50% de probabilidad de una distribución           | V / F       |
+------------------------------------------------------------------------------------+-------------+

## Autoevaluación \# 3 {.scrollable visibility="uncounted"}

Usando la variable `disp` de `mtcars`:

+----------------------------------------------------+---------------+
| La media aritmética es igual a                     | a\) 220.9     |
|                                                    |               |
|                                                    | b\) 139.0     |
|                                                    |               |
|                                                    | c\) 230.7     |
...
|                                                    | d\) 401.2     |
+----------------------------------------------------+---------------+
| La desviación estándar es igual a                  | a\) 33.1      |
|                                                    |               |
|                                                    | b\) 123.9     |
|                                                    |               |
|                                                    | c\) 120.2     |
...
|                                                    | d\) 210.7     |
+----------------------------------------------------+---------------+
| La varianza es igual a                             | a\) 1095.6    |
|                                                    |               |
|                                                    | b\) 15360.8   |
|                                                    |               |
|                                                    | c\) 14448.0   |
...
|                                                    | d\) 326.0     |
+----------------------------------------------------+---------------+
| El coeficiente de variación es                     | a\) 0.45      |
|                                                    |               |
|                                                    | b\) 0.15      |
|                                                    |               |
|                                                    | c\) 0.54      |
...
|                                                       |              |
| b\) Número total de observaciones                     | b\) 600      |
|                                                       |              |
